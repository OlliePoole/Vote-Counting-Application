...
namespace AlternativeVotingSystem.Model
{
    interface VCSModelInterface
    {
         ...
         */
        bool canLoadFileAtPath(String filePath);
         ...
         */
        bool canAddNewCandidateField(int currentFieldCount);
         ...
         */
        bool isValidCandidateWithName(String name);
